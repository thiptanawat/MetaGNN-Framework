...
<!-- map:start -->
_Generated by `tools/make_repro_map.py` from the documents built on 2026-09-12; the manuscript sources are not in the public checkout, so this is the last built numbering._
