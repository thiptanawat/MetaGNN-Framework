...
| `build_labels_ht29.py` | rebuilds the eleven-model union label from `11models.mat` (the eleven NCI-60 tINIT models of the Human1 publication data, Zenodo record 3583004; see `docs/REPRODUCTION_PAPER1.md`), checks that it reproduces the deposited vector exactly, and writes the tissue-matched HT29-only label used by the robustness check |
